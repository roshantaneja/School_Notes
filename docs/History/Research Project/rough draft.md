...
This resulted in a risk of proprietary software becoming necessary to navigate the internet. Fast forward about six years, and Berners-Lee comes into the picture. Berners-Lee noticed this risk and decided to take action. He developed a royalty-free network instead. Working at Cern, he integrated the preexisting TCP/IP and Hypertext technologies and created the first "World Wide Web." During the time, several other companies were attempting to capitalize on the newly regulated internet. Berners-Lee published the first website, which was self-serving (White Paper for the Web of Things | WPWT). The website described the world wide web and how to use it and invited collaborators to build on the technology. 
