...
var SlurpSettingsTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(containerEl).setName("Logs").setHeading();
...
var SlurpPlugin = class extends import_obsidian6.Plugin {
  constructor() {
    super(...arguments);
    this.displayError = (err) => new import_obsidian6.Notice(`Slurp Error! ${err.message}`);
  }
  async onload() {
