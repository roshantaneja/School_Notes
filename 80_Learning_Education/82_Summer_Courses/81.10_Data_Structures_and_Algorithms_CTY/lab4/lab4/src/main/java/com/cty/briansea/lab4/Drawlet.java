...
public abstract class Drawlet extends Region implements Tool {
     ...
     * modify an already created edu.ncssm.edu.briansea.pset5.Drawlet
     *
     * @return a new graphical element so that user can modify the edu.ncssm.edu.briansea.pset5.Drawlet or null if there are no options
     */
    @Override
